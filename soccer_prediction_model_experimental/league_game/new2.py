...
def populate_class_set(row,class_set):
	home_goal = row[4]
	away_goal = row[5]
	goal_dif = int(home_goal) - int(away_goal)
	goal_dif = discretized_value(goal_dif,pinpoints4)
	class_set.append(goal_dif)
...
feature_set3 = []
feature_set4 = []
for vector in feature_set[0:280*13]:
...
test_set3 = []
test_set4 = []
for vector in feature_set[280*13:280*14]:
	test_set1.append(vector[0:2])
	test_set2.append(vector[2:4])
	test_set3.append(vector[4:7])
	test_set4.append(vector)

class_set_sample = class_set[0:280*13]
class_set_test = class_set[280*13:280*14]
...
print(clf5.predict_proba([[3,3,3]]))
